  ...
  return (
    <>
      <nav>
        ...
        <div className="navContainer">
          <div>
            <NavLink to={base} className="NavLink">
              Home
            </NavLink>
            <NavLink to={`${base}Store`} className="NavLink">
              Store
            </NavLink>
            <NavLink to={`${base}About`} className="NavLink">
              About
            </NavLink>
          </div>
          <div>
            {cartQuantity > 0 ? (
              <button className="cartButton" onClick={() => openCart()}>
                ...
                <div className="cartItemsIndicator">
                  <div className="navBarQuantity">{cartQuantity}</div>
                </div>
              </button>
            ) : (
              <></>
